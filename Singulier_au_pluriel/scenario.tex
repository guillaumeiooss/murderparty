...
\pageForPlayer{9}{\nmPlayerIX}{
	...
	\item[Inconvénient majeur] Traquée du fait de son génôme et sa biologie particulière
	\item[Possessions] Nada
	...
	\begin{itemize}
		...
		\item Si tu décides d'avoir une vision (ce qui utilise une charge d'épice), il y aura toujours le flux de tachyon, mais la vision sera instantanée (pas de trance de une minute).
...
\pageForPlayer{10}{\nmPlayerX}{
	...
	\item[Possessions] Des dagues lasers cachées - Un blaster qui a été (temporairement) saisi par les autorités
...
\pageForPlayer{12}{\nmPlayerXII}{
	...
	\item[Atout majeur] Chimiste accompli
	\item[Inconvénient majeur] Risque de devoir faire du sale boulot si certains secrets sont révélés
	\item[Possessions] Du matériel d'analyse chimique et biologique
	\item[Entraînement au combat] Nada
}{
	\paragraph{Histoire personnelle}
