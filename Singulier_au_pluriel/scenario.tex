...
\pageForPlayer{3}{\nmPlayerIII}{
	...
	\item[Atout majeur] Jeune et innocent (ça compte?)
	\item[Inconvénient majeur] Complètement fauché
	
	\item[Possessions] Des miettes de pain au fond de tes po... ah non désolé, c'était ton repas de hier soir
	\item[Combat] Aucun entraînement
}{
	\paragraph{Histoire personnelle} Tu es l'ar
	
	
	études en
	
	Le problème, c'est qu'à force de faire des études et de changer de filière, ta bourse a expiré, et tu es en train de mettre les bouts pour 
	...
	\par Le gâteau en question finira de cuire vers
	
	
	Peut-être que
	
	Décrocher un job dans la section des paradoxes
	(au minimum un truc qui rapporte de l'argent)
